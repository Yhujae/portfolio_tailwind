      ...
      <div className='container mx-auto'>
        <div className='flex flex-col gap-y-10 lg:flex-row lg:items-center lg:gap-x-20 lg:gap-y-0 h-screen'>
          ...
          >
            ...
            <p className='mb-4'>
              Passionate about crafting seamless and captivating user
              experiences. Transforming ideas into pixel-perfect, responsive web
              applications with a keen eye for design and a love for clean,
              efficient code. Committed to bringing innovation to the digital
              world, one component at a time.
            </p>
